    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <!--- Products --->
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#orders"
...
from orders;");
                        ...
                        ?> <a class="nav-link" href="all-orders.php">All Orders <span style="color:#fff"> [
                                <?php echo $torders; ?>]
                            </span></a>
                        <a class="nav-link" href="new-order.php">New Orders <span style="color:#fff"> [
                                <?php echo $norders; ?>]
                            </span></a>
                        <a class="nav-link" href="packed-orders.php">Packed Orders <span style="color:#fff"> [
                                <?php echo $porders; ?>]
                            </span></a>
                        <a class="nav-link" href="dispatched-orders.php">Dispatched Order <span style="color:#fff"> [
                                <?php echo $dtorders; ?>]
                            </span></a>
                        <a class="nav-link" href="intransit-orders.php">In Transit Order <span style="color:#fff"> [
                                <?php echo $intorders; ?>]
                            </span></a>
                        <a class="nav-link" href="outfordelivery-orders.php">Out for Devlivery Order <span
                                style="color:#fff"> [
                                <?php echo $otforders; ?>]
                            </span></a>
                        <a class="nav-link" href="delivered-orders.php">Delivered Order <span style="color:#fff"> [
                                <?php echo $deliveredorders; ?>]
                            </span></a>
                        <a class="nav-link" href="cancelled-orders.php">Cancelled Order <span style="color:#fff"> [
